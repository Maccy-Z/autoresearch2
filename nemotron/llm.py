...
class NemotronHConfig(PreTrainedConfig):
    ...
    def __post_init__(self, **kwargs):
        ...
        if "hybrid_override_pattern" in kwargs:
            ...
            self.layer_types = ["mamba", "mlp", "attention", "mlp"]
    ...
    def validate_layer_type(self):
        ...
        valid_types = {"mamba", "attention", "mlp"}
    ...
    def _list_to_pattern(layers_list: list) -> str:
        ...
        reverse_mapping = {"mamba": "M", "attention": "*", "mlp": "-"}
    ...
    def _pattern_to_list(pattern: str) -> list:
        ...
        pattern_mapping = {"M": "mamba", "*": "attention", "-": "mlp"}
...
__all__ = ["NemotronHConfig", "NemotronHPreTrainedModel", "NemotronHModel", "NemotronHForCausalLM"]
